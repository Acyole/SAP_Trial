CLASS zlc_rap100_gen_data_r DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zlc_rap100_gen_data_r IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav_r.
    DELETE FROM zrp100_atrav_r_d.

    "insert travel demo data
    INSERT zrap100_atrav_r  FROM (
        SELECT
